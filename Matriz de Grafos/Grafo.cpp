...
// Efetua o calculo das distancias entre as cidades!
...
// Imprime a cidade com o maior numero de vizinhos
void ImprimeVizinhos(float **Grafo, dataItem *informacoesRN, float Distancia)
{
    int results[2] = {0, 0};
...
// imprimi as cidades com menor numero de vizinhos
void ImprimirSemVizinhos(float **Grafo, dataItem *informacoesRN, float *Distancias)
{
...
void ImprimirDistancias(dataItem *informacoesRN)
{
    float dist, maior = 0;
...
void minimadistancia(dataItem *informacoesRN)
{
    float dist, maior = 0;
...
void distanciamaximacidades(dataItem *informacoesRN)
{
